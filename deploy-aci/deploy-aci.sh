...
# need to change docker image 
ACI_IMAGE=jaredmagrath/mlflowserver-azure:1.8.2
...
ACI_MEMORY=1
AKV_NAME=keyvault$RANDOM    #need to change each time
ACR_NAME=mlflowservermodelrepo 
DB_NAME=mlflow
